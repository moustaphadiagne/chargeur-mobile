...
<title>CHARGEUR</title>
  ...
  <style>
    ...
    .switch {position: relative; display: inline-block; width: 60px; height: 38px} 
    .switch input {display: none}
    .slider {position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: #ccc; border-radius: 34px}
    .slider:before {position: absolute; content: ""; height: 22px; width: 22px; left: 8px; bottom: 8px; background-color: #fff; -webkit-transition: .4s; transition: .4s; border-radius: 68px}
...
setInterval(function ( ) {
  ...
  <p>
    <span class="dht-labels">TENSION</span>
...
String processor(const String& var){
  ...
  if(var == "TEMPERATURE"){
    ...
    buttons+= "<h4>ETAT <span id=\"outputState\"></span></h4><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"output\" " + outputStateValue + "><span class=\"slider\"></span></label>";
    return buttons;
  }
  return String();
}
...
tcaselect(1);
  ...
  server.on("/tension", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send_P(200, "text/plain", String(ina260.readBusVoltage()).c_str());
  });
